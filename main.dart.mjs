...
_1710: (x0,x1) => x0.send(x1),
_1712: x0 => x0.getAllResponseHeaders(),
_1720: f => finalizeWrapper(f,x0 => dartInstance.exports._1720(f,x0)),
_1738: (a, i) => a.push(i),
_1739: (a, i) => a.splice(i, 1)[0],
_1741: (a, l) => a.length = l,
_1742: a => a.pop(),
_1743: (a, i) => a.splice(i, 1),
_1745: (a, s) => a.join(s),
_1746: (a, s, e) => a.slice(s, e),
_1747: (a, s, e) => a.splice(s, e),
_1749: a => a.length,
_1751: (a, i) => a[i],
_1752: (a, i, v) => a[i] = v,
_1754: a => a.join(''),
_1755: (o, a, b) => o.replace(a, b),
_1757: (s, t) => s.split(t),
...
_1761: s => s.trimLeft(),
_1762: s => s.trimRight(),
_1764: (s, p, i) => s.indexOf(p, i),
_1765: (s, p, i) => s.lastIndexOf(p, i),
...
_1813: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1814: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1816: (s, m) => {
          try {
...
_1861: l => arrayFromDartList(Uint8Array, l),
...
_1871: stringFromDartString,
_1872: stringToDartString,
_1873: () => ({}),
_1874: () => [],
_1875: l => new Array(l),
_1876: () => globalThis,
...
_1903: (o, p) => o[p],
_1907: () => globalThis.window,
_1928: x0 => x0.matches,
_1932: x0 => x0.platform,
_1937: x0 => x0.navigator,
_1944: x0 => x0.status,
_1945: (x0,x1) => x0.responseType = x1,
_1947: x0 => x0.response,
...
_3826: x0 => x0.navigator,
_4307: x0 => x0.userAgent,
_14590: () => globalThis.window.flutterCanvasKit
    };
